...
**Gemini, Grok:** быстро вылетели с бесплатных trial. У Grok trial обещали — не дали.  
**OpenAI:** за качеством пришли сюда. Модель проверенная; заплатили примерно столько же, сколько просили Grok и Gemini. Для задач с жёсткой базой в промпте OpenAI даёт больше выбора моделей и за счёт этого — тонкую настройку под экономию (подобрать модель под задачу без лишних токенов).
